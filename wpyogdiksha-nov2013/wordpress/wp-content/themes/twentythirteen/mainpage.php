 ...
 */
 ...
 <?php /*get_header('main');*/ ?>
	...
	<div id="primary" class="content-area">
		...
		<div id="content" class="site-content" role="main" style="background: transparent url('http://localhost:8888/wpyogdiksha-nov2013/images/trident.jpg') no-repeat center top;background-attachment:fixed;background-size:cover">
